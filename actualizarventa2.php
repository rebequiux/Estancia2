...
if (!isset($_GET['nombre'])) {
    ...
    header("Location: gestionventas2.php");
    exit;
}
...
<body>
    <div class="container">
        ...
        <form method="POST" action="actualizarventa2.php?nombre=<?php echo htmlspecialchars($nombre_producto); ?>">
            <div class="mb-4">
        ...
        <div class="mt-3 text-center">
            <a href="gestionventas2.php" class="btn btn-link">Regresar</a>
        </div>
    </div>
</body>
</html>
