...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['actualizarproducto'])) {
    ...
    if ($producto && $descripcion && is_numeric($precio) && $proveedor > 0 && $categoria_id > 0) {
        ...
        if ($stmt->execute()) {
            header("Location: gestionproductos2.php?success=Producto actualizado correctamente");
            exit;
        } else {
...
<body>
    <div class="container mt-5">
        <div class="formulario mx-auto col-lg-6 col-md-8 col-sm-10">
            ...
            <form action="actualizarproducto2.php?id=<?php echo htmlspecialchars($id); ?>" method="POST">
                <div class="mb-3">
                ...
                <div class="text-center mt-3">
                    <a href="gestionproductos2.php">Volver a Gestión</a>
                </div>
            </form>
        </div>
    </div>
