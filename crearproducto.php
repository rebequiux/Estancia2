    ...
    if (!$producto || !$descripcion || !$precio || !$fecha_vencimiento || !$proveedor || !$categoria) {
        ...
        if ($check_stmt) {
            ...
            if ($row['total'] > 0) {
                ...
                if ($stmt) {
                    mysqli_stmt_bind_param($stmt, "ssssii", $producto, $descripcion, $precio, $fecha_vencimiento, $proveedor, $categoria);
        ...
        <form method="POST" action="">
            <div class="campo">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="producto" id="producto" class="form-control input-custom" 
                           placeholder="Nombre del producto" value="<?php echo htmlspecialchars($producto); ?>" required>
                </div>
            </div>
            ...
            <div class="campo">
                ...
                <textarea name="descripcion" id="descripcion" class="form-control input-custom" 
                          rows="3" placeholder="Descripción del producto" required><?php echo htmlspecialchars($descripcion); ?></textarea>
            </div>
            ...
            <div class="campo">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="precio" id="precio" class="form-control input-custom" 
                           placeholder="0.00" value="<?php echo htmlspecialchars($precio); ?>" required>
                </div>
            </div>
            ...
            <div class="campo">
                ...
                <input type="date" name="fecha_vencimiento" id="fecha_vencimiento" class="form-control input-custom" 
                       value="<?php echo htmlspecialchars($fecha_vencimiento); ?>" required>
            </div>

            <div class="campo">
                <label for="proveedor" class="label">Proveedor:</label>
                <select name="proveedor" id="proveedor" class="form-select input-custom" required>
            ...
            <div class="campo">
                ...
                <select name="categoria" id="categoria" class="form-select input-custom" required>
            ...
            <div class="text-center">
                ...
                <a href="gestionproductos.php" class="btn btn-back">Regresar</a>
            </div>
        </form>
    </div>
</div>
