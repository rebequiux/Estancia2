...
<?php include 'empleado_layout.php';?>
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <button class="btn btn-morado" onclick="window.location.href='crearproducto2.php'">Registrar Nuevo Producto</button>
    </div>
        ...
        <table class="table table-striped align-middle text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-icon btn-morado me-2" onclick="window.location.href='actualizarproducto2.php?id=<?php echo $rows['id']; ?>'">
                            Actualizar
                        </button><br><br>
                        <button class="btn btn-icon btn-danger" onclick="eliminarProducto2(<?php echo $rows['id']; ?>)">
                            Eliminar
                        </button>
                    </td>
                </tr>
    ...
    function eliminarProducto2(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = `eliminarproducto2.php?id=${id}`;
            }
        });
    }
</script>
