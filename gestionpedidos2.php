            ...
            <tbody>
                <?php if ($exec && $exec->num_rows > 0): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-icon btn-morado me-2" onclick="window.location.href='actualizarpedido2.php?id=<?php echo $rows['pedido_id']; ?>'">
                                Actualizar
                            </button>
                            <button class="btn btn-icon btn-danger" onclick="eliminarPedido2(<?php echo $rows['pedido_id']; ?>)">
                                Eliminar
                            </button>
                        </td>
                    </tr>
    ...
    function eliminarPedido2(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = `eliminarpedido2.php?id=${id}`;
            }
        });
    }
</script>
