...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button class="btn btn-morado" onclick="window.location.href='gestionusuarios.php'">Gestión de Usuarios</button>
        <button class="btn btn-morado" onclick="window.location.href='gestionproductos.php'">Gestión de Productos</button>
    </div>
                        ...
                        echo "<tr id='row-{$row['producto_id']}'>
                            ...
                            <td>
                                <div class='d-flex justify-content-center gap-2'>
                                    <button class='btn btn-warning btn-sm' onclick=\"window.location.href='actualizarventa.php?nombre={$row['nombre_producto']}'\">Actualizar</button>
