...
// Verificar inicio de sesión como cliente
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="index.php">Abarrotes Angeles</a>
            <div class="ms-auto">
        ...
        <div class="row">
            ...
            <?php foreach ($productos as $producto): ?>
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="img/<?= $producto['producto'] ?>.png" class="card-img-top" alt="<?= $producto['producto'] ?>">
                        <div class="card-body">
